...
const skills = [
  { name: "HTML", category: "Frontend", level: 5, icon: "🌐", sort_order: 1 },
  { name: "CSS", category: "Frontend", level: 5, icon: "🎨", sort_order: 2 },
  { name: "JavaScript", category: "Frontend", level: 5, icon: "⚡", sort_order: 3 },
  { name: "React", category: "Frontend", level: 4, icon: "⚛️", sort_order: 4 },
  { name: "Next.js", category: "Frontend", level: 4, icon: "▲", sort_order: 5 },
  { name: "Tailwind CSS", category: "Frontend", level: 5, icon: "💨", sort_order: 6 },
  { name: "PHP", category: "Backend", level: 5, icon: "🐘", sort_order: 1 },
  { name: "Laravel", category: "Backend", level: 5, icon: "⚙️", sort_order: 2 },
  { name: "Node.js", category: "Backend", level: 4, icon: "🟢", sort_order: 3 },
  { name: "Express", category: "Backend", level: 4, icon: "🚂", sort_order: 4 },
  { name: "REST API", category: "Backend", level: 5, icon: "🔗", sort_order: 5 },
  { name: "PostgreSQL", category: "Database", level: 4, icon: "🐘", sort_order: 1 },
  { name: "MySQL", category: "Database", level: 5, icon: "🗄️", sort_order: 2 },
  { name: "Supabase", category: "Database", level: 4, icon: "🔥", sort_order: 3 },
  { name: "Git", category: "Tools", level: 4, icon: "🌿", sort_order: 1 },
  { name: "Docker", category: "Tools", level: 3, icon: "🐳", sort_order: 2 },
  { name: "Figma", category: "Tools", level: 4, icon: "🖌️", sort_order: 3 },
];
